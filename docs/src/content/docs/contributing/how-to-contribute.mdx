...
1. Open a [Lesson Error issue](https://github.com/fischer3-net/github-for-ai-builders/issues/new?template=lesson-error.yml) using the structured form.
...
[New Exercise issue](https://github.com/fischer3-net/github-for-ai-builders/issues/new?template=new-exercise.yml).
...
1. Start a [Discussion](https://github.com/fischer3-net/github-for-ai-builders/discussions/new?category=ideas) in the Ideas category before opening any issue or PR.
2. Once there's consensus, open a [New Module issue](https://github.com/fischer3-net/github-for-ai-builders/issues/new?template=new-module.yml) — the form requires a link to the prior Discussion.

### Translate a Module

Translations are warmly welcomed. Before starting:

1. Open a [Discussion](https://github.com/fischer3-net/github-for-ai-builders/discussions) announcing your intent to avoid duplicate work.
...
3. **Add the upstream remote** so you can sync with the original:
   ...
   ```bash
   git remote add upstream https://github.com/fischer3-net/github-for-ai-builders.git
   ```
...
4. **Launch a Codespace** (recommended) — the devcontainer configures Python,
   ...
   ```bash
   gh codespace create --repo YOUR-USERNAME/github-for-ai-builders
   ```
...
[GitHub's private vulnerability reporting](https://github.com/fischer3-net/github-for-ai-builders/security/advisories/new)
instead. We'll acknowledge within 48 hours and aim to resolve within 14 days.

See [SECURITY.md](https://github.com/fischer3-net/github-for-ai-builders/blob/main/SECURITY.md)
for the full policy.
...
[CONTRIBUTORS.md](https://github.com/fischer3-net/github-for-ai-builders/blob/main/CONTRIBUTORS.md).
